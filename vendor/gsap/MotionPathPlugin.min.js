...
! function(t, e) {
    ...
    function y(t, e, n, r) {
        ...
        if ((o || !r) && o + n + 2 < a.length) return t.splice(e, 0, a.slice(0, n + o + 2)), a.splice(0, n + o), 1
    }
    ...
    function convertToPath(t, e) {
        var n, r, a, o, i, s, l, h, u, g, f, p, c, d, m, v, y, w, x, P, b, M, R = t.tagName.toLowerCase(),
            L = .552284749831;
    ...
    function sliceRawPath(t, e, n) {
        ...
        var i, s, l, h, u, g, f, p, c = 1 < n,
            ...
            T = M === R && L;
        if (c || r) {
            for (i = P < b || L && M < R || T && m.t < d.t, y(a, b, R, d.t) && (b++, i || (P++, T ? (m.t = (m.t - d.t) / (1 - d.t), M = 0) : L && (M -= R))), Math.abs(1 - (n - e)) < 1e-5 ? P = b - 1 : !m.t && P ? P-- : y(a, P, M, m.t) && i && b++, 1 === d.t && (b = (b + 1) % a.length), u = [], f = 1 + (g = a.length) * r, f += (g - (p = b) + P) % g, h = 0; h < f; h++) C(u, a[p++ % g]);
            a = u
    ...
    function measureSegment(t, e, n) {
        ...
        var r, a, o, i, s, l, h, u, g, f, p, c, d, m, v, y, w, x = ~~t.resolution || 12,
            P = 1 / x,
        ...
        for (T.length = C.length = 0, a = e + 2; a < b; a += 6) {
            if (o = t[a + 4] - M, i = t[a + 2] - M, s = t[a] - M, u = t[a + 5] - R, g = t[a + 3] - R, f = t[a + 1] - R, l = h = p = c = 0, H(o) < .01 && H(u) < .01 && H(s) + H(f) < .01) 8 < t.length && (t.splice(a, 6), a -= 6, b -= 6);
                ...
                for (r = 1; r <= x; r++) l = h - (h = ((m = P * r) * m * o + 3 * (d = 1 - m) * (m * i + d * s)) * m), p = c - (c = (m * m * u + 3 * d * (m * g + d * f)) * m), (y = $(p * p + l * l)) < S && (S = y), N += y, T[L++] = N;
            M += o, R += u
        }
        if (_)
            for (_ -= N; L < T.length; L++) T[L] += _;
        if (T.length && S) {
            if (t.totalLength = w = T[T.length - 1] || 0, w / (t.minLength = S) < 9999)
                for (y = v = 0, r = 0; r < w; r += S) C[y++] = T[v] < r ? ++v : v
    ...
    function getPositionOnPath(t, e, n, r) {
        var a, o, i, s, l, h, u, g, f, p = t[0],
            c = r || {};
        if ((e < 0 || 1 < e) && (e = d(e)), p.lookup || cacheRawPathMeasurements(t), 1 < t.length) {
            for (i = t.totalLength * e, l = h = 0;
    ...
    function arcToSegment(t, e, n, r, a, o, i, s, l) {
        if (t !== s || e !== l) {
            ...
            isNaN(I) && (I = f), !i && 0 < I ? I -= p : i && I < 0 && (I += p), E %= p, I %= p;
            var D, X = Math.ceil(H(I) / (p / 4)),
                k = [],
                z = I / X,
                G = 4 / 3 * F(z / 2) / (1 + U(z / 2)),
                Z = u * n,
                ...
                Y = g * -r,
                j = u * r;
            for (D = 0; D < X; D++) m = U(a = E + D * z), v = F(a), _ = U(a += z), N = F(a), k.push(m - G * v, v + G * m, _ + G * N, N - G * _, _, N);
            for (D = 0; D < k.length; D += 2) m = k[D], v = k[D + 1], k[D] = m * Z + v * Y + C, k[D + 1] = m * q + v * j + S;
    ...
    function stringToRawPath(t) {
        ...
        for (e = 0; e < x; e++)
            if (p = o, isNaN(m[e]) ? i = (o = m[e].toUpperCase()) !== m[e] : e--, r = +m[e + 1], a = +m[e + 2], i && (r += y, a += w), e || (l = r, h = a), "M" === o) s && (s.length < 8 ? --v.length : P += s.length), y = l = r, w = h = a, s = [r, a], v.push(s), e += 2, o = "L";
            else if ("C" === o) i || (y = w = 0), (s = s || [0, 0]).push(r, a, y + 1 * m[e + 3], w + 1 * m[e + 4], y += 1 * m[e + 5], w += 1 * m[e + 6]), e += 6;
        else if ("S" === o) u = y, g = w, "C" !== p && "S" !== p || (u += y - s[s.length - 4], g += w - s[s.length - 3]), i || (y = w = 0), s.push(u, g, r, a, y += 1 * m[e + 3], w += 1 * m[e + 4]), e += 4;
        else if ("Q" === o) u = y + 2 / 3 * (r - y), g = w + 2 / 3 * (a - w), i || (y = w = 0), y += 1 * m[e + 3], w += 1 * m[e + 4], s.push(u, g, y + 2 / 3 * (r - y), w + 2 / 3 * (a - w), y, w), e += 4;
        else if ("T" === o) u = y - s[s.length - 4], g = w - s[s.length - 3], s.push(y + u, w + g, r + 2 / 3 * (y + 1.5 * u - r), a + 2 / 3 * (w + 1.5 * g - a), y = r, w = a), e += 2;
        else if ("H" === o) Cf(y, w, y = r, w), e += 1;
        else if ("V" === o) Cf(y, w, y, w = r + (i ? w - y : 0)), e += 1;
        else if ("L" === o || "Z" === o) "Z" === o && (r = l, a = h, s.closed = !0), ("L" === o || .5 < H(y - r) || .5 < H(w - a)) && (Cf(y, w, r, a), "L" === o && (e += 2)), y = r, w = a;
        else if ("A" === o) {
            if (c = m[e + 4], d = m[e + 5], u = m[e + 6], g = m[e + 7], n = 7, 1 < c.length && (c.length < 3 ? (g = u, u = d, n--) : (g = d, u = c.substr(2), n -= 2), d = c.charAt(1), c = c.charAt(0)), f = arcToSegment(y, w, +m[e + 1], +m[e + 2], +m[e + 3], +c, +d, (i ? y : 0) + 1 * u, (i ? w : 0) + 1 * g), e += n, f)
    ...
    function R(t) {
        ...
        if (v = window, I = new j, e) {
            ...
            a && a.appendChild && (a.appendChild(n), n.appendChild(r), n.setAttribute("style", "position:static;transform:translate3d(0,0,1px)"), k = r.offsetParent !== n, a.removeChild(n))
        }
        return e
    }
    ...
    function Z(t, e) {
        if (t.parentNode && (c || R(t))) {
            ...
            return e && (n ? (E = E || Z(t), l.setAttribute("width", .01), l.setAttribute("height", .01), l.setAttribute("transform", "translate(" + o + "," + i + ")"), E.appendChild(l)) : (b || ((b = Z(t)).style.cssText = s), l.style.cssText = s + "width:0.1px;height:0.1px;top:" + i + "px;left:" + o + "px", b.appendChild(l))), l
        }
    ...
    function aa(t, e) {
        var n, r, a, o, i, s, l = X(t),
            ...
            u = l ? q : Y,
            g = t.parentNode,
            f = g && !l && g.shadowRoot && g.shadowRoot.appendChild ? g.shadowRoot : g;
        if (t === v) return t;
        if (u.length || u.push(Z(t, 1), Z(t, 2), Z(t, 3)), n = l ? E : b, l) h ? (o = -(a = function _getCTM(t) {
            var e, n = t.getCTM();
            ...
            return e
        }(r) : r.getItem(0).matrix : I).a * a.x + r.c * a.y, i = r.b * a.x + r.d * a.y) : (r = new j, o = i = 0), e && "g" === t.tagName.toLowerCase() && (o = i = 0), (h ? l : g).appendChild(n), n.setAttribute("transform", "matrix(" + r.a + "," + r.b + "," + r.c + "," + r.d + "," + (r.e + o) + "," + (r.f + i) + ")");
        else {
            if (o = i = 0, k)
            ...
            (a = n.style).top = t.offsetTop - i + "px", a.left = t.offsetLeft - o + "px", a[z] = s[z], a[G] = s[G], a.position = "fixed" === s.position ? "fixed" : "absolute", f.appendChild(n)
        }
        return n
    }
    ...
    var c, v, w, P, b, E, I, D, k, n, z = "transform",
        G = z + "Origin",
        q = [],
        Y = [],
    ...
    function ua(t, e, n, r) {
        var a, o = getGlobalMatrix(t.parentNode, !0, !0),
            ...
            h = l.x,
            u = l.y;
        return i.e = i.f = 0, "auto" === r && e.getTotalLength && "path" === e.tagName.toLowerCase() && (a = e.getAttribute("d").match(f) || [], h += (a = i.apply({
            x: +a[0],
            y: +a[1]
        })).x, u += a.y), a && (h -= (a = i.apply(e.getBBox())).x, u -= a.y), i.e = h - s.x, i.f = u - s.y, i
    }
    var Q, g, W, J, K, o, tt = "x,translateX,left,marginLeft,xPercent".split(","),
        ...
        nt = function _align(t, e, n) {
            var r, a, o, i = n.align,
                ...
                p = oa(e, "x"),
                c = oa(e, "y");
            return t && t.length ? (i && ("self" === i || (r = J(i)[0] || e) === e ? transformRawPath(t, 1, 0, 0, 1, p - g, c - f) : (u && !1 !== u[2] ? Q.set(e, {
        ...
        a = {
            ...
            register: function register(t, e, n) {
                W = (Q = t).utils.getUnit, J = Q.utils.toArray, K = Q.core.getStyleSaver, o = Q.core.reverting || function() {}, g = n
            },
            init: function init(t, e, n) {
                ...
                if (this.rawPaths = o, this.target = t, this.tween = n, this.styles = K && K(t, "transform"), (this.rotate = s || 0 === s) && (this.rOffset = parseFloat(s) || 0, this.radians = !!e.useRadians, this.rProp = e.rotation || "rotation", this.rSet = t._gsap.set(t, this.rProp, this), this.ru = W(t._gsap.get(t, this.rProp)) || 0), !Array.isArray(i) || "closed" in i || "number" == typeof f) cacheRawPathMeasurements(r = p(nt(getRawPath(e.path), t, e)), e.resolution), o.push(r), rt(this, t, e.x || "x", r, "x", e.unitX || "px"), rt(this, t, e.y || "y", r, "y", e.unitY || "px");
                else {
                    for (a in f) !u && ~tt.indexOf(a) ? u = a : !g && ~et.indexOf(a) && (g = a);
                    for (a in u && g ? o.push(qa(this, na(na([], i, u, 0), i, g, 1), t, u, g, p, e, l || W(i[0][u]), h || W(i[0][g]))) : u = g = 0, f) a !== u && a !== g && o.push(qa(this, na([], i, a, 2), t, a, 0, p, e, W(i[0][a])))
                }
